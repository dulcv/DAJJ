<template>
    ...
    <div id="app">
        ...
        <main>
            ...
            <h2 id="donacion">¡Haz tu donación!</h2>
            ...
            <form @submit.prevent="enviarDonacion">
                ...
                <input type="text" id="mensaje" name="mensaje" placeholder="Escribe algun mensaje..."
                    v-model="comentario" />
...
export default {
    ...
    data() {
        return {
            ...
            otro: '',
            comentario: '',
            mensaje: 'Tus datos están protegidos.'//Aqui lleva un icono
        }
    },
    methods: {
        enviarDonacion() {
